...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1) + "</em></td>\n          </tr>\n        ";
  return buffer;}

  buffer += "<div data-content=\"settings-";
  foundHelper = helpers.name;
  stack1 = foundHelper || depth0.name;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "name", { hash: {} }); }
  buffer += escapeExpression(stack1) + "\">\n  <div class=\"page-header\">\n    <div class=\"actions pull-right\">\n      <a class=\"btn btn-large\" href=\"#\" title=\"Modify\"\n        data-action=\"modify\" data-name=\"";
  foundHelper = helpers.name;
  stack1 = foundHelper || depth0.name;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "name", { hash: {} }); }
  buffer += escapeExpression(stack1) + "\">\n        <i class=\"icon-plus\"></i> Modify\n      </a>\n    </div>\n    <h1>";
  foundHelper = helpers.title;
  stack1 = foundHelper || depth0.title;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "title", { hash: {} }); }
  ...
  foundHelper = helpers.schema;
  stack1 = foundHelper || depth0.schema;
